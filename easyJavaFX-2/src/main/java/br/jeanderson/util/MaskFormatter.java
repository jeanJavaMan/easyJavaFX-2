...
public class MaskFormatter {
	...
	public void addComponente(Object objeto, MaskType maskType, boolean showMask) {
		if (objeto instanceof TextField) {
			this.addComponentes((TextField) objeto, maskType, showMask);
		} else if (objeto instanceof DatePicker) {
			this.addComponentes((DatePicker) objeto, maskType, showMask);
		}
	}
	...
	private void preparaMascara(TextField txtField, MaskType maskType, boolean showMask) {
		...
		default:
			System.out.println(
					"Nenhum tipo de máscara informada! Por favor informa o tipo da máscara usando o enum MaskType");
		}
	...
	/**
	 * Chama um evento que é executado quando usuário digita alguma coisa no campo,
	 * mudando caracteres de lugar para formar o padrão do tipo Telefone.
	 *
	 * @see MaskType
	 * @param textField
	 */
	...
	/**
	 * Chama um evento que é executado quando usuário digita alguma coisa no campo,
	 * mudando caracteres de lugar para formar o padrão do tipo CPF.
	 *
	 * @see MaskType
	 * @param textField
	 */
	...
	/**
	 * Chama um evento que é executado quando usuário digita alguma coisa no campo,
	 * mudando caracteres de lugar para formar o padrão do tipo RG.
	 *
	 * @see MaskType
	 * @param textField
	 */
	...
	/**
	 * Chama um evento que é executado quando usuário digita alguma coisa no campo,
	 * mudando caracteres de lugar para formar o padrão de Data com barra.
	 *
	 * @see MaskType
	 * @param datePicker
	 */
	...
	/**
	 * Chama um evento que é executado quando usuário digita alguma coisa no campo,
	 * mudando caracteres de lugar para formar o padrão de Data com traco.
	 *
	 * @see MaskType
	 * @param datePicker
	 */

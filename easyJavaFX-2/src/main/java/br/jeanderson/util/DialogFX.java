...
import br.jeanderson.controller.DialogConfirmation;
import br.jeanderson.controller.DialogInput;
import br.jeanderson.controller.DialogMessage;
...
public class DialogFX {
    ...
    public static String showInputText(String title, String header, String msg) {
        try {
            FXMLLoader loader = new FXMLLoader(DialogFX.class.getResource("/br/jeanderson/view/DialogInput.fxml"));
    ...
    private static Stage createDialogMessage(String title, String msg, DialogType type) {
        try {
            FXMLLoader loader = new FXMLLoader(DialogFX.class.getResource("/br/jeanderson/view/DialogMessage.fxml"));
            Parent root = loader.load();            
            Stage stage = new Stage(StageStyle.DECORATED);
            stage.setResizable(false);
            Scene scene = new Scene(root);
    ...
    private static boolean createDialogConfirmation(String title, String msg){
        try {
            FXMLLoader loader = new FXMLLoader(DialogFX.class.getResource("/br/jeanderson/view/DialogConfirmation.fxml"));
            Parent root = loader.load();            
            Stage stage = new Stage(StageStyle.DECORATED);
            stage.setResizable(false);
            Scene scene = new Scene(root);
